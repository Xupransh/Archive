...
class BinaryTree
{
    public:
        ...
        void recursiveHelper(Node * treeNode, vector<T> &s) const;
        ...
        void pathHelper(Node * treeNode, vector < vector<T> > & paths, vector<T> path) const;
        ...
        int sumRecurse(Node * treeNode, int sum) const;
        /**
